...
_Snapshot 2026-09-23T21:31:53.852543+00:00 · squad snapshot GW5_

## Freshness and deadline
- Current GW: 5
- Next deadline: 2026-10-10T10:00:00Z (Sat 10 Oct, 17:00 +07)

## #club-football position
- Rank: **3** · Points: **381** · Gap to leader: **11**
- Leader: FNN. (392 pts)
- Status: final for the latest completed gameweek

## Rules-only decision
- Status: ready
- Action: Investigate João Pedro before committing the transfer.
- Why: FPL lists 75% availability.
- Alternative: Hold the transfer until official team news is clearer.
- What would change this: Confirmed availability, minutes news, or a deadline-driven need to act.
- Jev layer: disabled. Jev is disabled. The desk is using deterministic rules only.
...
| FNN. | 1 | 392 | 4 | GW5 |
| -Nk_KOP | 2 | 391 | 8 | GW5 |
| Jazzjuman | 4 | 373 | 8 | GW5 |
| Azey | 5 | 372 | 3 | GW5 |
| Straku | 6 | 367 | 9 | GW5 |
| Pz | 7 | 365 | 7 | GW5 |
| JAE | 8 | 364 | 7 | GW5 |
| Minnie the Cookie | 9 | 363 | 6 | GW5 |
| visarutdear | 10 | 358 | 6 | GW5 |
...
- Research official club and manager news for flagged players, transfer targets, and captain candidates.
- Compare hold/wait against up to three realistic moves over the next six gameweeks.
- Do not set a lineup or make a transfer recommendation after the deadline.
